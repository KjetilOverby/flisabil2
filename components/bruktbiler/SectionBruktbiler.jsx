      ...
      <Grid container className={classes.container}>
        ...
        <Grid item className={classes.textContainer}>
          <Typography variant="body1">
            Flisa Bil har drevet bilsalg siden slutten av 1990-tallet. Vi har
            biler i alle prisklasser og samtlige biler er taksert og selges med
            garanti med mindre noe annet er tydelig opplyst.
          </Typography>
          <br />
          <Typography variant="body1">
            ...
            garanti, takstativ, skibokser, foliering/profilering og annet
            ekstrautstyr til bilen.
          </Typography>
        </Grid>
        <Grid item>
